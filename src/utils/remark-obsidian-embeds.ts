      ...
      <strong>Loading base…</strong>
        ...
        if ((url.startsWith('attachments/') || url.includes('/attachments/')) && file.path) {
          ...
          if (url.startsWith('/')) {
            ...
            const isFolderPost = file.path.includes('/posts/') && file.path.endsWith('/index.mdx');
            const isFolderPage = file.path.includes('/pages/') && file.path.endsWith('/index.mdx');
            const isFolderProject = file.path.includes('/projects/') && file.path.endsWith('/index.mdx');
            const isFolderDoc = file.path.includes('/docs/') && file.path.endsWith('/index.mdx');
