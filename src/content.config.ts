...
const creditPersonSchema = z.union([
  z.string(),
  z.object({
    name: z.string(),
...
const creditsSchema = z
    .object({
      authors: z.array(creditPersonSchema).optional(),
      editors: z.array(creditPersonSchema).optional(),
      photographers: z.array(creditPersonSchema).optional(),
      disassembly: z.array(creditPersonSchema).optional(),
    })
    .optional();
