...
function checkImageExists(imageSrc, filePath) {
  ...
  const isFolderBasedPost = filePath.endsWith('index.mdx') && isPostsFile;
  const isFolderBasedProject = filePath.endsWith('index.mdx') && isProjectsFile;
  const isFolderBasedDoc = filePath.endsWith('index.mdx') && isDocsFile;
